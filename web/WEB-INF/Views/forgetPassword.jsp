                            ...
                            <div class="card-body p-5 text-center">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <form action="forgetpass" method="post">
                                        ...
                                        <button data-mdb-button-init data-mdb-ripple-init class="btn custom-btn btn-lg px-5" type="submit">Nhập password </button>
                                    </form>
                                    <p class="small mb-5 pb-lg-2"><a class="custom-link" href="login">Return Login Page</a></p>
